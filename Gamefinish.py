...
def brown_door():
    ...
    sleep(1)
    print('You remember working here alongside friends')
    sleep(1)
    print('')
    main_factory()
...
def pipe_flood():
    print('looking around you see a ladder going to the next floor, you also see a hole in th wall with light shining from it.')
    sleep(1)
    ...
    if answer.lower().strip() == 'a':
        ...
        sleep(1)
        print('Waiting at train station a train arrives and you get on it.')
        print(PURPLE + 'THE TRAIN PART BROKE IN TESTING AND DIDNT HAVE TIME TO FIX SO IM SENDNIG YOU TO A PUZZLE 4TH WALL BREAK SPOOKY STUFF OOOOOOOOOOOOOOOOOOOOOOOOOOW')
        palin()
        #train_cart()
    elif answer.lower().strip() == 'b':
